...
<title>EduNet || All Event Reports</title>
<style>
    *{
        color:#fff;
    }
...
<body class="bg-dark p-3 m-3">
    ...
    <div class="container">
            <h2 style="text-align: center;">All event report</h2>
                ...
                <tr>
                    ...
                    <th>Event place</th>
                      <th>Event description</th>
                        <th>Start regestration date</th>
                          <th>End regestration date</th>
                            <th>Event date</th>
                              <th>Eventtime</th>
                                <th>Event fees</th>
                </tr>
                <?php
                $data = mysqli_query($con,"SELECT *  FROM tblevent");
                while($res = mysqli_fetch_array($data))
                {
                        echo "<tr>";
                            echo "<td>".$res['event_id']."</td>";
                             echo "<td><img src='../../themes/metronic/theme/default/demo1/dist/assets/media/event/".$res['event_photo_path']."' alt='img not found' style='width:50px;' class='rounded'/></td>";
                            echo "<td>".$res['event_name']."</td>";
                            echo "<td>".$res['event_place']."</td>";
                            echo "<td>".$res['event_description']."</td>";
                            echo "<td>".$res['event_start_regestration_date']."</td>";
                             echo "<td>".$res['event_end_regestration_date']."</td>";
                              echo "<td>".$res['event_date']."</td>";
                               echo "<td>".$res['event_time']."</td>";
                                echo "<td>".$res['event_fees']."</td>";
                        echo "</tr>";
                }
            ?>
                </table>
