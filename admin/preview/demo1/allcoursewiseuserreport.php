...
<title>EduNet || All course wise User Reorts</title>
<style>
    *{
        color:#fff;
    }
...
<body class="bg-dark p-3 m-3">
    ...
    <div class="container">
            <h2 style="text-align: center;padding: 10px;">All course wise User report</h2>
            <table class="table table-hover table-responsive">
                ...
                <?php
                $data = mysqli_query($con,"SELECT * FROM tbluser as u,tblusercourse as uc,tblcourse as c WHERE u.u_id = uc.user_id AND c.course_id=uc.course_id");
                   // echo $data;
                while($res = mysqli_fetch_array($data))
                {
                        echo "<tr>";
                            echo "<td>".$res['u_id']."</td>";
                            echo "<td><img src='../../themes/metronic/theme/default/demo1/dist/assets/media/user/".$res['u_photo_path']."' alt='img not found' style='width:50px;' class='rounded'/></td>";
                            echo "<td>".$res['u_first_name']."</td>";
                            echo "<td>".$res['u_middle_name']."</td>";
                            echo "<td>".$res['u_last_name']."</td>";
                            echo "<td>".$res['u_city']."</td>";
                            echo "<td>".$res['u_ph_no']."</td>";
