                            ...
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc" id="kt_subheader_total">
                                        Enter News details and submit </span>
                                        ...
                                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                                            ...
                                            <form class="kt-form" id="kt_user_add_form" enctype="multipart/form-data" action="" method="post">
                                                ...
                                                <div class="kt-wizard-v4__content" data-ktwizard-type="step-content"
                                                    data-ktwizard-state="current">
                                                    <div class="kt-heading kt-heading--md">News Details:</div>
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <div class="kt-section__body">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label
                                                                                class="col-xl-3 col-lg-3 col-form-label">News Title</label>
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                ...
                                                                                <span id="ename_error" class="kt-font-danger"></span>
                                                                                  ...
                                                                                  <div class="form-group row">
                                                                            <label
                                                                                class="col-xl-3 col-lg-3 col-form-label">News Picture</label>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <textarea class="form-control" rows="3" id="edescription" name="edescription" placeholder="Enter Description  "></textarea>
  ...
  <script>
    $(document).ready(function(){
        ...
        $('#ename').keypress(function(){
          ...
          {
            $('#ename_error').html("*Enter Valid News Title");
            $('#ename_error').show();  
            // $('#firstname').focus();
        ...
        $('#eplace').keypress(function(){
           mname = $('#eplace').val();
          var mname_regx = /^[a-z-_ A-Z]{1,400}$/;
        ...
        $('#edescription').keypress(function(){
          ...
          var lname_regx = /^[a-z,'-_ A-Z]{1,400}$/;
          ...
          {
            $('#edescription_error').html("Provide Enough description,maximum Character 400");
...
<?php
        ...
        //echo "<script>alert('$user_img_type');</script>";
            if( empty($ename) || empty($photo) || empty($edescription) || empty($edate))
            {
                echo "<script>   
                        $(document).ready(function(){
        ...
        $upload_folder_name="../../../../../themes/metronic/theme/default/demo1/dist/assets/media/news/".$uniquesavename.$_FILES['photo']['name'];
        $user_img_type=$_FILES['photo']['type'];
        $photo_size = $_FILES['photo']['size'];//30720byte = 30kb =0.0293mb = 0.00003gb //2097152
        ...
        //echo $store;
                ...
                //move_uploaded_file($image_tmp_name,$upload_folder_name);
                 move_uploaded_file($image_tmp_name,$upload_folder_name);
                $insert = "INSERT INTO `tblnews` VALUES(NULL,'$ename','$edescription','$edate','$store')";
                //echo $insert; 
