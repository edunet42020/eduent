...
$uid=$_REQUEST['id'];
$query="SELECT * FROM `tblfaculty` WHERE f_id=$uid";
//echo "<script>alert(". $query .")</script>";
$result=mysqli_query($con,$query);
$row=mysqli_fetch_assoc($result);
$photo=$row['f_photo_path'];
//echo "<script>alert(".$row['f_ph_no'].")</script>";
?>
...
<head>
    ...
    <title>EduNet || Edit Faculty</title>
                            ...
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc" id="kt_subheader_total">
                                        Make faculty Active or De-Active</span>
                                ...
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-grid">
                                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                                            ...
                                            <form class="kt-form" id="kt_user_add_form" enctype="multipart/form-data" action="edit-faculty.php?id=<?php echo $uid; ?>" method="post">
                                                <!--begin: Form Wizard Step 1-->
                                                <div class="kt-wizard-v4__content" data-ktwizard-type="step-content"
                                                    data-ktwizard-state="current">
                                                    <div class="kt-heading kt-heading--md">Faculty's Profile Details:</div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <div class="kt-section__body">
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                <div class="col-lg-9 col-xl-6">
                                                                                    <div class="kt-avatar kt-avatar--outline kt-avatar--circle- kt-avatar--changed" id="kt_user_edit_avatar">
                                                                                        <div class="kt-avatar__holder"  ><img  src="<?php echo "../../../../../themes/metronic/theme/default/demo1/dist/assets/media/faculty/".$photo; ?>" height="120" width="120" id="image" /></div>
                                                                                        <!-- 
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label
                                                                                class="col-xl-3 col-lg-3 col-form-label">Faculty's
                                                                                Name</label>
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <input class="form-control" type="text" id="fname" name="fname"
                                                                                placeholder="Enter Your Name." value="<?php echo $row['f_name'];  ?>" disabled>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <span class="kt-switch">
                                                                                <label>
                                                                                    <input type="checkbox" value="Active" name="cstatus" id="cstatus" <?php if($row['f_status']=="Active")echo "checked";?> >
                                                                                    <span></span>
                                                                                </label>
                                                                            </span>
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                ...
                                                                                placeholder="Provide Description." value="<?php echo $row['f_description'];  ?>"  disabled>
                                                                                <span id="description_error" class="kt-font-danger"></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <label
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                ...
                                                                                placeholder="Enter Your Qualification." value="<?php echo $row['f_qualification']; ?> "  disabled>
                                                                                <span id="qualification_error" class="kt-font-danger"></span>
                                                                            </div>
                                                                        </div>
      ...
      //  $user_img_type=$_FILES['photo']['type'];
       //$photo_size = $_FILES['photo']['size'];//30720byte = 30kb =0.0293mb = 0.00003gb //2097152
        ...
        //echo "<script>alert('$user_img_type');</script>";
                                        ...
                                        $query="UPDATE `tblfaculty` SET f_status='$cstatus' WHERE f_id='$uid'";
                                        //$insert = "INSERT INTO `tbluser` VALUES(NULL,'$fname','$mname','$lname','$upload_folder_name','$city', $mobile,'$email','$encode_pass')";
                                        //echo $query; 
                                        if(mysqli_query($con,$query))
                                        {
                                            header("Location: ../../../crud/metronic-datatable/advanced/row-details.php");
                                        }
                                        echo $insert_row;  
          //  }
