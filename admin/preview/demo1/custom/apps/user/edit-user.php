...
define("imageroot","C:/xampp/htdocs/edunet/admin/themes/metronic/theme/default/demo1/dist/assets/media/users/");
//echo "<script>alert(".$_REQUEST['id'].")</script>";
$uid=$_REQUEST['id'];
$query="SELECT * FROM `tbluser` WHERE   U_ID=$uid";
//echo "<script>alert(". $query .")</script>";
$result=mysqli_query($con,$query);
$row=mysqli_fetch_assoc($result);
$photo=$row['u_photo_path'];

//echo "<script>alert(".$row['u_first_name'].")</script>";
?>
                            ...
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc" id="kt_subheader_total">
                                        Make user Active or De-Active </span>
                                ...
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-grid">
                                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                                            ...
                                            <form class="kt-form" id="kt_user_add_form" enctype="multipart/form-data" action="edit-user.php?id=<?php echo $uid; ?>" method="post">
                                                                    ...
                                                                    <div class="kt-section__body">
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                <div class="col-lg-9 col-xl-6">
                                                                                    <div class="kt-avatar kt-avatar--outline kt-avatar--circle- kt-avatar--changed" id="kt_user_edit_avatar">
                                                                                        <div class="kt-avatar__holder"  ><img  src="<?php echo "../../../../../themes/metronic/theme/default/demo1/dist/assets/media/user/".$photo; ?> " height="120" width="120" id="image" /></div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <input class="form-control" type="text" disabled id="firstname" name="firstname"
                                                                                placeholder="Enter Your First Name." value="<?php echo $row['u_first_name']; ?>">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label
                                                                                ...
                                                                                Name</label>
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <input class="form-control" type="text" disabled id="middlename" name="middlename"
                                                                                placeholder="Enter Your Middle Name." value="<?php echo $row['u_middle_name'];?> ">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label
                                                                                ...
                                                                                Name</label>
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <input class="form-control" type="text" disabled id="lastname" name="lastname"
                                                                                    placeholder="Enter Your Last Name." value="<?php echo $row['u_last_name']; ?> "  >
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <input class="form-control" type="text" disabled id="lastname" name="lastname"
                                                                                    placeholder="Enter Your Last Name." value="<?php echo $row['u_city']; ?> "  >
                                                                                    <span id="lastname_error" class="kt-font-danger"></span>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <span class="kt-switch">
                                                                                <label>
                                                                                    <input type="checkbox" value="Active" name="cstatus" id="cstatus" <?php if($row['u_status']=="Active")echo "checked";?> >
                                                                                    <span></span>
                                                                                </label>
                                                                            </span>
                                                                            </div>
          ...
          //  {
                ...
                //$encode_pass = base64_encode($pass);
                                       // move_uploaded_file($image_tmp_name,$upload_folder_name);
                                        $query="UPDATE `tbluser` SET u_status='$cstatus' WHERE u_id='$uid'";
                                        //$insert = "INSERT INTO `tbluser` VALUES(NULL,'$fname','$mname','$lname','$upload_folder_name','$city', $mobile,'$email','$encode_pass')";
                                        //echo $insert; 
                                        if(mysqli_query($con,$query))
                                        {
                                            header("Location: ../../../crud/metronic-datatable/advanced/record-selection.php");
                                        }
                                        echo $insert_row;  
          //  }
