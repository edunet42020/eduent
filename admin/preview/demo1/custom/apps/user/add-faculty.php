...
define("imageroot","C:/xampp/htdocs/edunet/themes/metronic/theme/default/demo1/dist/assets/media/faculty/");
...
<head>
    ...
    <title>EduNet || Add faculty</title>
                            ...
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc" id="kt_subheader_total">
                                        Enter Faculty details and submit </span>
                                ...
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-grid">
                                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                                            ...
                                            <form class="kt-form" id="kt_user_add_form" enctype="multipart/form-data" action="add-faculty.php" method="post">
...
<?php
        ...
        $upload_folder_name="C:/xampp/htdocs/edunet/themes/metronic/theme/default/demo1/dist/assets/media/faculty/".$_FILES['photo']['name'];
        ...
        //echo "<script>alert('$user_img_type');</script>";
            if( empty($fname) ||empty($mobile) || empty($photo) || empty($pass)|| empty($description)|| empty($qualification) )
            {
                echo "<script>   
                        $(document).ready(function(){
            ...
            else
            {
               // echo "<script>alert('$mobile');</script>";
                $encode_pass = base64_encode($pass);
                                        ...
                                        $insert = "INSERT INTO `tblfaculty` VALUES(NULL,'$fname',$mobile,'$description','$upload_folder_name','$qualification','$encode_pass')";
                                        echo $insert; 
