                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label
                                                                                ...
                                                                                <select id="cfaculty" name="cfaculty" class="btn btn-outline-primary">
                                                                                
                                                                                <?php
                                                                                    $query="select * from `tblfaculty` where f_status='Active'";
                                                                                    $res=mysqli_query($con,$query);
                                                                                    //$row=mysqli_fetch_array($res);
                                                                                    while($row=mysqli_fetch_array($res))
                                                                                    {
...
<?php
        ...
        //echo "<script>alert('$user_img_type');</script>";
            if(empty($cname) ||empty($cdescription) || empty($cfulldescription) || empty($cfaculty) || empty( $cstatus)|| empty($coursestartdate)|| empty($courseenddate) || empty( $courseprice) )
            {
                echo "<script>   
                        $(document).ready(function(){
            ...
            else
            {
                if($user_img_type=="image/jpeg" || $user_img_type=="image/jpg" || $user_img_type=="image/png")
                {
                    ...
                    $insert = "INSERT INTO `tblcourse` VALUES(NULL,'$cname','$cdescription','$cfulldescription','$store','$cstatus','$coursestartdate','$courseenddate','$courseprice',$cfaculty,'$ccategory')";
                    echo $insert; 
                    echo "<script>alert('$insert');</script>";
                   ...
                   if(mysqli_query($con,$insert))
                    {
                        ...
                        ";
                        header("Location:sendfacultyemail.php?fid=$cfaculty&sd=$coursestartdate&ed=$courseenddate"); 
