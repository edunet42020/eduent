                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="dropdown dropdown-inline">
                                <a href="http://localhost/edunet/admin/preview/demo1/custom/apps/user/add-book.php" style="color:#fff;" type="button" class="btn btn-brand btn-icon-sm">
