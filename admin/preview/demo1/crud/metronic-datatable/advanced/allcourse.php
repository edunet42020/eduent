                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="dropdown dropdown-inline">
                                <a href="http://localhost/edunet/admin/preview/demo1/custom/apps/user/add-course.php" style="color:#fff;" type="button" class="btn btn-brand btn-icon-sm">
...
<script>
 ...
 if(isset($_REQUEST['emailmsg']))
            {
                if($_REQUEST['emailmsg']='ok')
                {
                    echo "<script>alert('Email send successfully');</script>";
                }
                else
                {
                    echo "<script>alert('Email Not send,please let them know manualy');</script>";
                }
            }
        ?> 