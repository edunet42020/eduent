...
else
{
  ...
  $query = "SELECT * FROM `tblquestionmcq` WHERE CONCAT(`q_id`,`question`,`option1`,`option2`,`option3`,`option4`,`answer`,`explanation`) LIKE '%$search%' ORDER BY $dat LIMIT $start_from,$record_per_page";
