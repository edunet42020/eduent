                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            Feedback Datatable
                            <small>Feedback's Details</small>
                        </h3>
                    </div>
                    <!--
...
<?php 
    if(isset($_REQUEST['emailmsg']))
    {
        echo "<script>
            ...
            echo "<meta http-equiv='Refresh' content='1; URL=http://localhost/edunet/admin/preview/demo1/crud/metronic-datatable/advanced/allfeedback.php/>";
    }
?>