                                ...
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-grid">
                                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                                            ...
                                            <form class="kt-form" id="kt_user_add_form" action="add-user.php" method="post">
                                                                    ...
                                                                    <div class="kt-section__body">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <div class="col-md-3 kt-form__actions">
                                                                                ...
                                                                                <button class="btn btn-success btn-md btn-tall btn-wide kt-font-bold kt-font-transform-u" id="btnreg" name="btnreg" type="button" >
                                                                                    Submit
                                                                                        </button>&nbsp;
...
<?php
    ...
    if(isset($_POST['btnsubmit']))
    {
      ...
      $upload_folder_name=imageroot.$_FILES['photo']['name'];
        ...
        else
        {
            if($user_img_type=="image/jpeg" || $user_img_type=="image/jpg" || $user_img_type=="image/png")
            {
                ...
                if(filter_var($email,FILTER_VALIDATE_EMAIL))
                {
                    ...
                    {
                        if(preg_match("/^[a-zA-Z]{3,16}$/",$mname))
                        {
                            if(preg_match("/^[a-zA-Z]{3,16}$/",$lname))
                            {
                                if(preg_match("/^[0-9]{10}$/",$mobile))
                                {
                                    move_uploaded_file($image_tmp_name,$upload_folder_name);
                                    $insert = "insert into tbluser values(NULL,'$fname','$mname','$lname','$upload_folder_name','$address', $mobile,'$email','$encode_pass')";
                                    //echo $insert; 
                                    $insert_row=mysqli_query($conect,$insert);
                                    echo $insert_row;
                                }
                                else
                                {
