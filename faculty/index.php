			...
			<div class="wrap-login100" style="padding-top:60px;">
				...
				<form class="login100-form validate-form" method="post" action="">
					...
					<div class="container-login100-form-btn">
								...
								<a class="text-center" href="regestration.php">    Create new account</a>
							</div>
					<div>
...
if(isset($_POST['adminlogin']))
{
	...
	// echo "<script>alert('$encodepwd');</script>";
		$query="select * from tblfaculty where f_emailid='$username' AND f_pwd='$encodepwd'";
		//echo $query;
	...
	if($count>0)
	{
		...
		echo "<meta http-equiv='Refresh' content='1; URL=http://localhost/edunet/faculty/preview/demo1/index.php'/>";	
				}
				else
				{
					echo "	<script>   
		 $(document).ready(function(){
			 $('#login_failed').html('you are not Active right now');    
		 $('#login_failed').show();
		 });
	 </script>";
				}
...
<?php
 if(isset($_REQUEST['g']))
	{
		echo "<script>
	        swal('Done!','you are Successfully regestred,please wait for our admins confirmation','success');               
	    	</script>";
