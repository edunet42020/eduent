...
<title>EduNet || Passout student Report</title>
<style>
    *{
        color:#fff;
    }
...
<body class="bg-dark p-3 m-3">
    ...
    <div class="container">
            <h2 style="text-align: center;padding: 10px;">Students passout from your course</h2>
...
select * from tbluser as u,tblcourse as c,tblcertificate as cr,tblresult as r where u.u_id=cr.user_id and c.course_id = cr.course_id and c.course_t_id = $id and r.user_id=cr.user_id and c.course_id=r.course_id");
