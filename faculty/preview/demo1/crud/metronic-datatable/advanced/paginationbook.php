  ...
  <thead class="kt-datatable__head">
    <tr class="kt-datatable__row" style="left: 0px;">
      ...
      <th data-field="ShipAddress" class="kt-datatable__cell kt-datatable__cell--sort">
        <span ><a href="#" class="btn btn-outline-primary" name='sortmname' onclick="load_data('1','pdf_id','<?php if (isset($search)) {echo "$search"; } ?>');">Booke&nbsp;<span class="fas fa-sort"></span></a></span>
      </th>
      ...
      <th data-field="Country" class="kt-datatable__cell kt-datatable__cell--sort">
        <span ><a href="#" class="btn btn-outline-primary" name='sortfname' onclick="load_data('1','pdf_path','<?php if (isset($search)) {echo "$search";} ?>');">Book path&nbsp;<span class="fas fa-sort"></span></a></span>
      </th>
