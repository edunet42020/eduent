...
<head>
    ...
    <title>Edunet-Faculty || view questions</title>
                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            Questions Datatable
                            <small>Question's Details</small>
                        </h3>
                    </div>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="dropdown dropdown-inline">
                                <a href="http://localhost/edunet/preview/demo1/custom/apps/user/add-question.php" style="color:#fff;" type="button" class="btn btn-brand btn-icon-sm">
