...
$query = "SELECT * FROM tblexam as e ,tblcourse as c where e.course_id=c.course_id and c.course_t_id=$facultyid ORDER BY exam_id LIMIT $start_from, $record_per_page";
if(empty($search))
{
if (isset($_POST["sort"])) {
  $dat=$_POST["sort"];
  $query = "SELECT * FROM tblexam as e ,tblcourse as c where e.course_id=c.course_id and c.course_t_id=$facultyid ORDER BY $dat LIMIT $start_from, $record_per_page";
...
else
{
  ...
  $query = "SELECT * FROM tblexam as e ,tblcourse as c WHERE CONCAT(`exam_id`,`exam_no`,`exam_name`,`week_id`,`course_name`)  LIKE '%$search%' and e.course_id=c.course_id and c.course_t_id=$facultyid ORDER BY $dat LIMIT $start_from,$record_per_page"; 
}
// echo $query;
$result = mysqli_query($connect, $query);
?>
