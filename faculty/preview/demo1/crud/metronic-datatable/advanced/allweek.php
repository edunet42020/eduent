...
<head>
    ...
    <title>Edunet-Faculty || week</title>
                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            Week Datatable
                            <small>Week Details</small>
                        </h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="dropdown dropdown-inline">
                                <a href="http://localhost/edunet/faculty/preview/demo1/custom/apps/user/add-week.php" style="color:#fff;" type="button" class="btn btn-brand btn-icon-sm">
