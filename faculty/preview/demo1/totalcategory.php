                ...
                while($res = mysqli_fetch_array($data))
                {
                        echo "<tr>";
                            echo "<td>".$res['category_id']."</td>";
                             $photo="http://localhost/edunet/admin/themes/metronic/theme/default/demo1/dist/assets/media/category/".$res['category_photo_path'];
                             echo "<td><img src='$photo' alt='img not found' style='height:100px;width:100px;' class='rounded'/></td>";
