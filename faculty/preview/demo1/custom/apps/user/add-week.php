...
define("imageroot","http://localhost/edunet/faculty/themes/metronic/theme/default/demo1/dist/assets/media/");
?>
<?php
...
<head>
    ...
    <title>Edunet-Faculty || Add Week</title>
                            ...
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc" id="kt_subheader_total">
                                        Enter Period details and submit </span>
                                ...
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    <div class="kt-grid">
                                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                                            ...
                                            <form class="kt-form" id="kt_user_add_form" enctype="multipart/form-data" action="" method="post" name="myform">
                                                <!--begin: Form Wizard Step 1-->
                                                <div class="kt-wizard-v4__content" data-ktwizard-type="step-content"
                                                    data-ktwizard-state="current">
                                                    <div class="kt-heading kt-heading--md">Period Details:</div>
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <div class="kt-section__body">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label
                                                                                class="col-xl-3 col-lg-3 col-form-label">Period title</label>
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <input class="form-control" type="text" id="wname" name="wname"
                                                                                placeholder="Enter Period Title." value="<?php if(isset($_POST['wname'])) echo "$_POST[wname]"; ?>">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                ...
                                                                                placeholder="Enter Chapter Name." value="<?php if(isset($_POST['cname'])) echo "$_POST[cname]"; ?>">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="date"
                                                                                        class="form-control"
                                                                                        id="startdate"
                                                                                        value="<?php if(isset($_POST['startdate'])) echo "$_POST[startdate]"; else echo date('Y-m-d'); ?>"
                                                                                        name="startdate"
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input 
                                                                                        type="date"
                                                                                        class="form-control"
                                                                                        value="<?php if(isset($_POST['enddate'])) echo "$_POST[enddate]"; else echo date('Y-m-d'); ?>"
                                                                                        id="enddate"
                                                                                        name="enddate"
                                                                                        aria-describedby="basic-addon1"
                                                                                        onclick="return changedate()";>     
                                                                                </div>
...
<script type="text/javascript">
    function changedate()
    {
        var n=document.myform.startdate.value;
  ...
  <script>
    $(document).ready(function(){
        ...
        $('#wname').keypress(function(){
           fname = $('#wname').val();
          var fname_regx = /^[a-z ,'-_"0-9A-Z]{1,50}$/;
        ...
        $('#cname').keypress(function(){
           mname = $('#cname').val();
          var mname_regx = /^[a-z -_A-Z0-9]{1,50}$/;
...
<?php
        ...
        //echo "<script>alert('$user_img_type');</script>";
            ...
            {
                $insert = "INSERT INTO `tblweek` VALUES(NULL,'$wname','$cname','$startdate','$enddate','$courseid')";
                           // $insert = "UPDATE `tblweek` set week_title='$wname',chap_name='$cname', course_description='$cname', course_full_description='$cfulldescription',course_photo_path='$store', course_status='$coursestatus',course_start_date='$startdate',course_end_date='$enddate',course_prize='$courseprice' where course_id=$cid";
                            if(mysqli_query($con,$insert) or die(mysqli_error($con)))
                            {
                                ...
                                Swal.fire({
                                    ...
                                    window.location ='http://localhost/edunet/faculty/preview/demo1/crud/metronic-datatable/advanced/allweek.php';
                                });
                                </script>
