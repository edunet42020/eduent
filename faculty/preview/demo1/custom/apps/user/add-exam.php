...
<head>
    ...
    <title>Edunet-Faculty || Add Exam</title>
                            ...
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc" id="kt_subheader_total">
                                        Enter Exam details and submit </span>
                                                                ...
                                                                <div class="col-xl-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                ...
                                                                                placeholder="Enter Exam No." value="<?php if(isset($_POST['exnum'])) echo "$_POST[exnum]"; ?>">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                ...
                                                                                placeholder="Enter Exam Title." value="<?php if(isset($_POST['exname'])) echo "$_POST[exname]"; ?>">
