...
<head>
    ...
    <title>Edunet-Faculty || Edit Course</title>
                           ...
                           if(mysqli_query($con,$insert) or die(mysqli_error($con)))
                            {
                                ...
                                Swal.fire({
                                    ...
                                    window.location ='http://localhost/edunet/faculty/preview/demo1/crud/metronic-datatable/advanced/allcourse.php?days=$days';
                                });
                                </script>
