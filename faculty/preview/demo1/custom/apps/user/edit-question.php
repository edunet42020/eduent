...
$cid=$_REQUEST['id'];
$query="SELECT * FROM `tblquestionmcq` WHERE q_id=$cid";
...
$examid=$row['exam_id'];
$data=mysqli_query($con,"SELECT * FROM `tblexam` WHERE exam_id=$examid");
...
<head>
    ...
    <title>Edunet-Faculty || Edit Question</title>
                                                                    ...
                                                                    <div class="kt-section__body">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                ...
                                                                                placeholder="Enter Question Here.." value="<?php echo $row['question']; ?>">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-4 col-xl-4">
                                                                                ...
                                                                                placeholder="Option_A." value="<?php echo $row['option1']; ?>">
                                                                                <span id="op1_error" class="kt-font-danger"></span>
                                                                            </div>
                                                                            <div class="col-lg-4 col-xl-4">
                                                                                <input class="form-control" type="text" id="op2" name="op2"
                                                                                placeholder="Option_B." value="<?php echo $row['option2']; ?>">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label
                                                                                ...
                                                                                placeholder="Option_C." value="<?php echo $row['option3']; ?>">
                                                                                <span id="op3_error" class="kt-font-danger"></span>
                                                                            </div>
                                                                            <div class="col-lg-4 col-xl-4">
                                                                                <input class="form-control" type="text" id="op4" name="op4"
                                                                                placeholder="Option_D." value="<?php echo $row['option4']; ?>">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-xl-4 col-lg-4 col-form-label">
                                                                                ...
                                                                                placeholder="Answer....." value="<?php echo $row['answer']; ?>">
                                                                                <span id="ans_error" class="kt-font-danger"></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <label
                                                                                class="col-xl-4 col-lg-4 col-form-label">Explanation</label>
                                                                            <div class="col-xl-4 col-lg-4 col-form-label">
                                                                                <input class="form-control" type="text" id="exp" name="exp"
                                                                                placeholder="Proviode Elplanation Here.." value="<?php echo $row['explanation']; ?>">
  ...
  <script>
    $(document).ready(function(){
        ...
        $('#ans').keypress(function(){
          ...
          {
            $('#ans_error').html("Enter Proper Explanation");
            $('#ans_error').show();
            // $('#middlename').focus();
...
<?php
        ...
        $examid=$_REQUEST['ename'];
            ...
            {
                $insert = "UPDATE `tblquestionmcq` set question='$que',option1='$op1',option2='$op2',option3='$op3',option4='$op4',answer='$ans',explanation='$exp',exam_id='$examid',course_id='$courseid' where q_id='$cid'";
