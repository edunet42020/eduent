...
<head>
    ...
    <title>Edunet-Faculty || Add video</title>
                            ...
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc" id="kt_subheader_total">
                                        Enter Video details and submit </span>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                ...
                                                                                value="<?php echo isset($_POST["videoname"]) ? $_POST["videoname"] : ''; ?>"
                                                                                >
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                ...
                                                                                value="<?php echo isset($_POST["videodescription"]) ? $_POST["videodescription"] : ''; ?>"
                                                                                >
        ...
        else
        {
            if(empty($videoname))
            {
                echo "<script>   
                       ...
                       // $insert = "INSERT INTO `tblcourse` VALUES(NULL,'$videoname','$videodescription','$cfulldescription','$store','$cstatus','$coursestartdate','$courseenddate','$courseprice','$cfaculty','1')";
            ...
            else
            {
                        ...
                        $insert = "INSERT INTO `tblvideo` VALUES(NULL,'$videoname','$videostore','$videodes','$courseid','$weekid','$facultyid')";
                        echo $insert; 
                        //echo "<script>alert('$insert');</script>";
